 ...
 console.log(locations.state.card);
  return (
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:mx-52 my-12 mx-4 border-2 px-12 py-3 rounded-lg border-green-500 bg-transparent hover:bg-slate-300">
        <div>
          <img
